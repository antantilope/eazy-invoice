    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.invoice')),
                ('rate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.hourlyrate')),
            ],
            options={
                'abstract': False,
            },
